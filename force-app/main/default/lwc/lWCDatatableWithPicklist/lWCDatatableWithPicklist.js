...
import getAccountData from "@salesforce/apex/FacultyCustomerDetails.getAccountData";
...
const columns = [
  ...
  {
    label: "Attendance",
    fieldName: "Attendence__c",
    type: "picklistColumn",
    editable: { fieldName: "AttendenceDisable" },
    typeAttributes: {
...
export default class CustomDatatableDemo extends LightningElement {
  ...
  //veera sudhakar Search
  handelSearchKey(event) {
    this.searchKey = event.target.value;
    //call Apex method.
    getAccountData({ textkey: this.searchKey })
      .then((result) => {
        console.log("this.data Database", result);
        ...
        res.forEach((item) => {
          ...
          createAttendence({ EId: item.id })
            .then((result) => {
              ...
              this.showToast(
                "Success",
                "Attendence Created Successfully!",
                "success",
                "dismissable"
              );
              //return this.refresh();
